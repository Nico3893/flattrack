...
Inventory.create!(category: livingroom, name: "KNIPPE", historic_value: 17.99, book_value: 11.99, description: "coat rack", condition: "used", flat: f6, photo: "https://res.cloudinary.com/djn5khfwt/image/upload/v1563876119/flattrack/inventory_photos/coat_rack_xgvv5a.jpg", replaced: false, deleted: false)
