...
Inventory.create!(category: bedroom, name: "SONGESAND", historic_value: 179.00, book_value: 119.00 , description: "white wardrobe", condition: "scratces at the feet from vacuum cleaning", flat: f1, photo: "https://res.cloudinary.com/djn5khfwt/image/upload/v1563876118/flattrack/inventory_photos/songesand.JPG_edvevm.jp2", replaced: false, deleted: false)
...
Inventory.create!(category: kitchen, name: "MARTIN", historic_value: 21.99, book_value: 16.74, description: "chair", condition: "used", flat: f1, photo: "https://res.cloudinary.com/djn5khfwt/image/upload/v1563876116/flattrack/inventory_photos/chair_mi7aau.jp2", replaced: false, deleted: false)
...
Inventory.create!(category: bathroom, name: "BLANKSJÖN", historic_value: 6.99, book_value: 0.00, description: "bath mat", condition: "replace", flat: f2, photo: "https://res.cloudinary.com/djn5khfwt/image/upload/v1563876116/flattrack/inventory_photos/bath_mat_wgynca.jp2", replaced: false, deleted: false)
